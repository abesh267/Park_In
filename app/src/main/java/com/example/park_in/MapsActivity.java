...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openMenu = (Button) findViewById(R.id.btnOpenMenu);
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        switch (menuItem.getItemId()){
                            case R.id.item_daily:
                                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://r.mtdv.me/IY48mFKPKo")));
                                return true;
                            case R.id.item_monthly:
                                startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://r.mtdv.me/D70GxQ11Ww")));
                                return true;
                            default:
                                return false;
                        }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                Toast.makeText(MapsActivity.this, "Click on Rent button to rent " + markertitle, Toast.LENGTH_SHORT).show();
                setVisibileButton();
                return false;

            }

            private void setVisibileButton() {
                openMenu = (Button) findViewById(R.id.btnOpenMenu);
